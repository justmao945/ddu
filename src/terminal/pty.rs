...
use portable_pty::{native_pty_system, Child, ChildKiller, CommandBuilder, MasterPty, PtyPair, PtySize};
...
impl PtyProcess {
    ...
    pub fn spawn(
        ...
        Ok((Self { writer: PtyWriter::new(writer), master, killer }, reader, child))
    }
