...
use ddu_diff::file_view::FileView;
use ddu_diff::{
...
mod tests {
    ...
    fn the_view_toggle_switches_surface_on_a_markdown_file() {
        ...
        use ddu_core::config::{Config, ShellConfig, State};
        use ddu_diff::{DiffFile, GitDiff};
        use gpui::Entity;
    ...
    fn preview_falls_back_to_rows_and_bands_the_reason() {
        ...
        use ddu_diff::file_view::PreviewBuild;
        use ddu_diff::read::Unreadable;
